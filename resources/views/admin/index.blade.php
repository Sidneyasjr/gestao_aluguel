...
<head>
    ...
    <title>S.A Imobiliária - Gestão de Aluguel</title>
</head>
<body>
        ...
        <article class="dash_login_left_box">
            ...
            <form name="login" action="{{ route('admin.login.do') }}" method="post" autocomplete="off">
                <label>
                    ...
                    <input type="email" name="email" placeholder="Informe seu e-mail" value="sidney@sidneyandrade.com.br"/>
                </label>
            ...
            <footer>
                <p>Desenvolvido por <a href="https://www.sidneyandrade.com.br">www.<b>sidneyandrade</b>.com.br</a></p>
                <p>&copy; <?= date("Y"); ?> - Todos os Direitos Reservados</p>
                <p class="dash_login_left_box_support">
                    <a target="_blank"
                       class="icon-whatsapp transition text-green"
                       href="https://api.whatsapp.com/send?phone=55+047+991158947&text=Olá, preciso de ajuda com o login."
