...
@section('content')
    <section class="dash_content_app">
        ...
        <header class="dash_content_app_header">
            <h2 class="icon-user">Editar Propriétario</h2>
        ...
        <div class="dash_content_app_box">
            <div class="nav">
                ...
                <form class="app_form" action="{{ route('admin.owners.update', ['owner' => $owner]) }}" method="post"
                        ...
                        <div id="data">
                            ...
                            <div class="label_g4">
                                <label class="label">
                                    ...
                                    <input type="number" min="1" max="28" name="day_transfer"
                                           placeholder="Dia do repasse"
                                           value="{{ old('day_transfer') ?? $owner->day_transfer }}"/>
                                </label>
                            </div>
